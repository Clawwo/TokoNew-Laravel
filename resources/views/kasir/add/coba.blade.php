...
<main id="content"
    ...
    <div
        class="relative w-4/12 mx-auto bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 mt-36">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute inset-y-0 hidden pointer-events-none end-0 pe-3">
                                    <svg class="text-red-500 size-5" width="16" height="16"
