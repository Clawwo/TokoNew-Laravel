                        ...
                        <div
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                <thead class="bg-gray-50 dark:bg-neutral-800">
                                    <tr>
                                        <th
                                            class="py-3 text-xs font-semibold tracking-wide text-gray-800 uppercase ps-6 text-start dark:text-neutral-200">
                                            Code</th>
                                        <th
                                            class="px-6 py-3 text-xs font-semibold tracking-wide text-gray-800 uppercase text-start dark:text-neutral-200">
                                            Date Payment</th>
                                        <th
                                            class="px-6 py-3 text-xs font-semibold tracking-wide text-gray-800 uppercase text-start dark:text-neutral-200">
                                            Customer</th>
