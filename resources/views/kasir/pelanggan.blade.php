                                ...
                                <div class="flex flex-col items-center gap-4 sm:flex-row">
                                    <div class="flex items-center px-4 py-2 bg-gray-100 rounded-lg dark:bg-neutral-800">
                                        <span class="text-sm text-gray-600 dark:text-neutral-400">
                                            Total Customers:
                                            <span
                                                class="ml-1 font-semibold text-gray-900 dark:text-neutral-200">{{ $total_pelanggan }}</span>
                                        </span>
                                    </div>
                                ...
                                <div class="px-6 py-2 bg-blue-50 dark:bg-blue-900/20">
                                    <div class="flex items-center justify-between">
                                        <p class="text-sm text-blue-600 dark:text-blue-400">
                                            ...
                                            <span class="font-medium">({{ $total_pelanggan }} hasil)</span>
                                        </p>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                    @foreach ($pelanggan as $plgn)
                                        <tr
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium {{ $plgn->gender === 'L' ? 'bg-blue-100 text-blue-800 dark:bg-blue-800/20 dark:text-blue-400' : 'bg-pink-100 text-pink-800 dark:bg-pink-800/20 dark:text-pink-400' }}">
                                            ...
                                            <td colspan="6" class="px-6 py-12">
                                                <div class="text-center">
                                                    ...
                                                    <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">
                                                        {{ request('search') ? 'Tidak ada hasil yang cocok dengan pencarian Anda.' : 'Belum ada data pelanggan yang tersedia.' }}
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
