                    ...
                    <div class="p-1.5 min-w-full inline-block align-middle">
                        <div
                            ...
                            <div
                                ...
                                <div>
                                    <h2 class="mb-2 text-xl font-semibold text-gray-800 dark:text-neutral-200">
                                        Customer
                                    </h2>
                                    ...
                                    <div class="inline-flex gap-x-2">
                                        <div
                                            ...
                                            <div>
                                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                                    <span
                                                        class="font-semibold text-gray-800 dark:text-neutral-200">{{ $total_pelanggan }}</span>
                                                    results
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <thead class="bg-gray-50 dark:bg-neutral-800">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-start">
                                            <div class="flex items-center gap-x-2">
                                                <span
                                                    class="text-xs font-semibold tracking-wide text-gray-800 uppercase dark:text-neutral-200 px-14">
                                                    Gender
                                                </span>
                                            </div>
                                        </th>
                                    ...
                                    @foreach ($pelanggan as $plgn)
                                        <tr>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="py-3 ps-6 lg:ps-3 xl:ps-0 pe-6">
                                                    <div class="flex items-center gap-x-3">
                                                        ...
                                                        <div class="grow">
                                                            <span
                                                                class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $plgn->nama }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800 px-14 dark:text-neutral-200">{{ $plgn->gender }}</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="text-sm text-gray-500 dark:text-neutral-500">{{ $plgn->created_at }}</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
